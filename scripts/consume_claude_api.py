#!/usr/bin/env python3
"""
每日消耗 Claude API 配额脚本
使用方法: python consume_claude_api.py
"""
...
from src.common.config import load_llm_config, PROVIDER_CLAUDE
...
def consume_api():
    """消耗 API 配额"""
    print(f"开始消耗 Claude API - {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
